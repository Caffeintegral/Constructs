...
export class SkillPage {
  ...
  raisokukoujouSkill() {
    ...
    var SP = parseFloat(this.ship.torpRange) * 0.8
    this.ship.torpRange = Math.round(SP * 10) / 10

  }

  gyoraisenmonkaSkill() {
    var SP = parseFloat(this.ship.torpLoadingTime) * 0.9
    this.ship.torpLoadingTime = Math.round(SP * 10) / 10
  }
  ...
  gyorai3Skill() {
    var SP = parseFloat(this.ship.torpLoadingTime) * 0.85
    this.ship.torpLoadingTime = Math.round(SP * 10) / 10
  ...
  taiku3Skill() {
    var SP = parseFloat(this.ship.AADamage) * 1.25
    this.ship.AADamage = Math.round(SP * 10) / 10

  }

  AAFlagSkill() {
    var SP = parseFloat(this.ship.AADamage) * 1.10
    this.ship.AADamage = Math.round(SP * 10) / 10
  }
