...
function indiaFlag(ischecked){
    if (ischecked == true) {
        if (document.form1.Caliber.value < 160) {
            currentShipData[6] += 1.005;
            currentShipData[8] += 1.005;
        }
        if (document.form1.Caliber.value > 160) {
            currentShipData[6] += 1.01;
            currentShipData[8] += 1.005;
        }
